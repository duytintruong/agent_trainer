...
**Tests**: Per the constitution's "Test-First" principle, tests are NOT optional. For each user story, tests MUST be written first and must be failing before implementation begins.
...
- [ ] T001 Create project structure per implementation plan (e.g., using `npm create-next-app@latest` or a similar tool)
...
- [ ] TXXX [P] Additional unit tests (if requested) in src/__tests__/
